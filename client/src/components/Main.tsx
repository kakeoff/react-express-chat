                  ...
                  <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                    <div className="relative group">
                      <input
                        ...
                        type="text"
                        value={values[NAME]}
                        className="peer placeholder-transparent text-white h-10 w-full group-hover:border-purple-500 transition duration-300 border-b-[1px] bg-transparent focus:outline-none focus:border-rose-600"
                        placeholder="NAME"
                    ...
                    <div className="relative group">
                      <input
                        ...
                        value={values[ROOM]}
                        type="text"
                        className="peer placeholder-transparent text-white group-hover:border-purple-500 transition duration-300 bg-transparent h-10 w-full border-b-[1px] border-gray-300 focus:outline-none focus:border-rose-600"
                        placeholder="ROOM"
                        onChange={handleChange}
                        required
                      />
